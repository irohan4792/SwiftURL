...
import Loader from "./components/spinner.gif"
...
const handleCopy=()=>{
  ...
  return (
    <div>
    {loading ? (<div style={{marginTop:"20%",display:"flex", alignItems:"center", justifyContent:"center" }}><img src={Loader}  width={100} alt="loading" /></div>):(
      <>
      <Togglebutton/>
        ...
        <div className="card">
          <div className="card2">
            <form className="form" onSubmit={handleSubmit}>
              ...
              <button onClick={handleClick} className="button3">Convert</button>
            </form>
          </div>
        </div>
      </div>
